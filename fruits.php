...
<head>
  ...
  <title>Fruits | CropConnect</title>
...
<body>
  <div class="navbar">
    ...
    <a class="active" href="fruits.php">Fruits</a>
  ...
  <div class="container">
    ...
    <div class="product-container">
      ...
      $sql_fruits = "SELECT 
        ...
        WHERE Product.CatID = (SELECT CatID FROM category WHERE Category = 'Fruits')";

      $result_fruits = $conn->query($sql_fruits);

      if ($result_fruits->num_rows > 0) {
        while ($row_fruits = $result_fruits->fetch_assoc()) {
          echo '<a href="product_details.php?productID=' . $row_fruits["ProductID"] . '" class="product-link">';
          echo '<div class="product-card">';
          echo '<img class="product-image" src="' . $row_fruits["Image"] . '" alt="' . $row_fruits["ProductName"] . '">';
          echo '<p><strong>' . $row_fruits["ProductName"] . '</strong></p>';
          echo '<p><strong>Price:</strong> ₹' . $row_fruits["Price"] . ' per kg</p>';
          echo '<p><strong>Available Quantity:</strong> ' . $row_fruits["Quantity_avail"] . ' kg</p>';
          echo '<p><strong>Farmer:</strong> ' . $row_fruits["FarmerName"] . '</p>';
          echo '<p><strong>Location:</strong> ' . $row_fruits["FarmerLocation"] . '</p>';
          echo '</div>';
          echo '</a>';
        }
      } else {
